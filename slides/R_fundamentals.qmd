...
-   can access single values at position in a vector via an index "[2]"
...
> You won't be able to complete Friday's lab if this is not complete, so be sure to give yourself enough time if issues come up. I have office hours before this is due in class.