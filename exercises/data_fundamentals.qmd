...
<iframe width="560" height="315" src="https://www.youtube.com/embed/PRn0v8rNyPI?start=48" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen>
...
nyc_urban_ranger %>%
  ...
  geom_col() +
  coord_flip() +
  labs(title="Top 10 Most Common Species for which NYC Urban Park Rangers Assistance is Requested, 2018-2025", x = "Species", y = "Count") +
  theme_minimal() +
