...
There will be 2 coding interviews associated with Project 1 and Project 3 respectively, focusing on assessing your understanding of the key concepts and coding skills taught in this course. For each coding interview, your project group will have a meeting with the SDS 192 instructors (Prof. Poirier and Prof. Cao) for 20 minutes. To prepare for these meetings, each of you will identify one piece of code you have written for your project that demonstrates your understanding of pre-defined course skills. During the meeting, you and the instructors will have a conversation around these pieces of code, but the content of the conversation may also delve into other coding exercises in order to probe your understanding of these standards assessed. Afterwards, the instructors will give you a brief summary of the meeting and assess your level of understanding. For each skill assessed in the interview you can earn 30 points (unsatisfactory), 70 points  (satisfactory), or 100 points (exceptional). The score for your coding interview will be averaged with your team's project score (with a 3:1 weight) for a final project score. 
...
[Mid-term Review](midterm-review.html)
